...
<body>
    <div id="container">
        <img id="login-image" src="../Static/login image.jpg" alt="Login image">
        <a href="home.php"><img id="logo" src="../Static/logo image.png" alt="Logo"></a>
    ...
    if (isset($_POST['sign'])) {
        if (
            isset($_POST['fname']) && !empty($_POST['fname']) and
