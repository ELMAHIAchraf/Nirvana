...
function heartClick(productIndex) {
  let j = 0;
  let color =
    document.getElementsByClassName("heart")[productIndex].style.color;
  ...
  if (j % 2 == 0) {
    document.getElementsByClassName("heart")[productIndex].style.color =
      "#ee4747";
    document.getElementsByClassName("heart")[productIndex].style.transition =
      "color 0.5s";
  } else {
    document.getElementsByClassName("heart")[productIndex].style.color =
      "#ffbfbf";
  ...
  j++;
  document
    .getElementsByClassName("heart")
    [productIndex].setAttribute("class", "fa-solid fa-heart heart");
}
function addToWishlist(productIndex) {
  let id_article =
    document.getElementsByClassName("id_article")[productIndex].value;
  let color =
    document.getElementsByClassName("heart")[productIndex].style.color;
  let xhr = new XMLHttpRequest();
  if (color == "rgb(238, 71, 71)") {
...
function brokenHeart(productIndex) {
  if (
    ...
    document
      .getElementsByClassName("heart")
      [productIndex].setAttribute("class", "fa-solid fa-heart-crack heart");
  } else {
    document
      .getElementsByClassName("heart")
      [productIndex].setAttribute("class", "fa-solid fa-heart heart");
