  ...
  xhr.onload = function () {
    if (xhr.status == 200) {
      if (xhr.responseText == 1) {
        document.getElementById("addToCart-butt").innerHTML =
          "<i class='fa-solid fa-cart-arrow-up' id='cart-icon'></i>&ensp;Remove";
      } else {
        document.getElementById("addToCart-butt").innerHTML =
          "<i class='fa-solid fa-cart-arrow-down' id='cart-icon'></i>&ensp;Add to cart";
      }
    }
  };
  xhr.open(
    "GET",
    "cart check.php?id_article=" + id_article + "&color=" + colorWithoutSharp,
    true
  );
  xhr.send();
...
function displayReviews() {
  if (k % 2 == 0) {
    ...
    document.getElementById("reviews-display").innerHTML =
      'Hide all customers reviews<i class="fa-sharp fa-solid fa-angle-up" id="down-arrow-reviews"></i>';
    ...
    document.getElementById("reviews-display").innerHTML =
      'See all customers reviews<i class="fa-sharp fa-solid fa-angle-down" id="down-arrow-reviews"></i>';
...
function heartClick() {
  ...
  if (c % 2 == 0) {
    document.getElementById("wishlist").innerHTML =
      "<i class='fa-solid fa-heart-crack heart'></i>&nbsp; Remove";
    document.getElementById("wishlist").style.backgroundColor = "#ff4444";
  } else {
    document.getElementById("wishlist").innerHTML =
      "<i class='fa-solid fa-heart heart'></i>&nbsp; Add to wishlist";
...
function hideImage() {
  if (
    event.target.id == "transparent-bg" ||
    event.target.id == "image-div" ||
    event.target.id == "displayed-img"
  ) {
