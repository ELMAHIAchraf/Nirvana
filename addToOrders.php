<?php
    session_start();
        ...
        while($tab=mysqli_fetch_assoc($query)){
            $sql2="INSERT INTO orders VALUES('', {$_SESSION['id_client']}, {$tab['id_article']}, '$order_date', '$delivery_date', '{$tab['color']}', {$tab['quantity']}, '', '', '', 0, '{$tab['id_color']}', '$order_token', '{$_POST['transaction_id']}')";
